<div class="container">
    ...
    <div class="breed-sheet__header">
        ...
        <?php else: ?>
            <div class="breed-sheet__icon"><i class="fa-solid fa-dog"></i></div>
        <?php endif; ?>
        <div>
    ...
    <div class="breed-sheet__grid">
        ...
        <div class="breed-sheet__col">
            ...
            <div class="breed-sheet__section">
                <h2 class="breed-sheet__section-title"><i class="fa-solid fa-file-lines"></i> Description</h2>
            ...
            <div class="breed-sheet__section">
                <h2 class="breed-sheet__section-title"><i class="fa-solid fa-scroll"></i> Historique</h2>
        ...
        <div class="breed-sheet__col">
            ...
            <div class="breed-sheet__section">
                <h2 class="breed-sheet__section-title"><i class="fa-solid fa-scissors"></i> Conseils d'entretien</h2>
            ...
            <div class="breed-sheet__section breed-sheet__section--highlight">
                <h2 class="breed-sheet__section-title"><i class="fa-solid fa-lightbulb"></i> Astuces de toilettage</h2>
    ...
    <div class="breed-sheet__cta">
        <a href="<?= BASE_URL ?>/index.php?controller=reservation&action=create" class="btn btn-primary">
            <i class="fa-solid fa-calendar-check"></i> Prendre rendez-vous pour votre <?= htmlspecialchars($breed->nomRace) ?>
        </a>
    </div>
